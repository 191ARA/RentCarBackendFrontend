...
public class AdminController {
    ...
    @Autowired
    public AdminController(UserRepository userRepository, CarRepository carRepository, BookingRepository bookingRepository, BCryptPasswordEncoder passwordEncoder) {
    ...
    public ResponseEntity<User> updateUser(@PathVariable Long id, @RequestBody User userDetails) {
        return userRepository.findById(id)
                .map(user -> {
                    ...
                    // Обновляем пароль только если предоставлен новый

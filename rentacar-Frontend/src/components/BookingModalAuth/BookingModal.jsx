...
export default function BookingModal({ isOpen, onClose, car, onSubmit }) {
  ...
  // Загрузка забронированных диапазонов для автомобиля
  useEffect(() => {
    if (car?.id) {
      axios
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.message || t('bookingError');
            ...
            <DatePicker
              ...
              dayClassName={(date) => {
                ...
                if (date.getTime() === startDate?.getTime())
                  return 'selected-start-day';
                if (date.getTime() === endDate?.getTime())
                  return 'selected-end-day';
                if (
                  startDate &&
                  endDate &&
                  date > startDate &&
